...
INSERT INTO `ims`.`customers` (`first_name`, `surname`) VALUES ('peter', 'dagley');
INSERT INTO `ims`.`customers` (`first_name`, `surname`) VALUES ('jim', 'jimson');
INSERT INTO `ims`.`customers` (`first_name`, `surname`) VALUES ('bob', 'bobson');

INSERT INTO `ims`.`items` (`item_name`, `price`) VALUES ('apple', '1.00');
