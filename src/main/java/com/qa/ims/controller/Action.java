 ...
 */
public enum Action {
	CREATE("To save a new entity into the database"), READALL("To read all entities from the database"), READ("To read an entity from the database"),
	UPDATE("To change an entity already in the database"), DELETE("To remove an entity from the database"),
	RETURN("To return to domain selection"), ADDITEM("Add an item to an order");
